...
COPY app/ ./app/
COPY schema.sql wsgi.py import_csv.py import_awards.py seed_admin.py fix_show_titles.py backup_db.py enrich_show_info.py suggest_historical_regions.py ./
